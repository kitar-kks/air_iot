...
//   RAir2_alarm.data_length = 4;
//
//   RAir1_status.data = (int8_t*) malloc(sizeof(int) * 3);
//   RAir2_status.data = (int8_t*) malloc(sizeof(int) * 3);
//   RAir1_status.data_length = 3;
//   RAir2_status.data_length = 3;

   RAir_setting.data = (int8_t*) malloc(sizeof(int) * 5);
   RAir_setting.data_length = 5;

   Rsource_fail.data = (int8_t*) malloc(sizeof(int) * 2);
  ...
  if(millis() - time_temp >= 1000)
  {
   ...
   if(button_nextion_press == true)
   {
    ///// setting
     ...
     RAir_setting.data[1] = myNex.readNumber("n1.val");    // temp on
     RAir_setting.data[2] = myNex.readNumber("n2.val");  // temp off
     RAir_setting.data[3] = myNex.readNumber("n3.val"); // humid on
     RAir_setting.data[4] = myNex.readNumber("n4.val"); // humid off
     ...
     h =  RAir_setting.data[0];
     air1_time_count = h*60*60;
     air2_time_count = h*60*60;
     t_on = RAir_setting.data[1];
     t_off = RAir_setting.data[2];
     h_on = RAir_setting.data[3];
     h_off = RAir_setting.data[4];
